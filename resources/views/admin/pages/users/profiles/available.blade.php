...
@section('title', 'Perfis disponíveis para o usero {$user->name}')
...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('users.profiles.available', $user->id) }}"
                class="active">Disponíveis</a></li>
    </ol>

    <h1>Perfis disponíveis para o usero <strong>{{ $user->name }}</strong></h1>
